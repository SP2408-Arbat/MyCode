					...
					<div class="row-fluid" align="center">
						<div id="newProductCar" class="carousel slide">
							<div class="carousel-inner">
								...
								<form action="bidderViewProducts.jsp" method="POST">
									<table>
										<tr>
										...
										<li class="span3">
											<div class="thumbnail">
												<div class="caption cntr">
													...
													<hr />
													<h4>
														<a class="shopBtn" href="AddToCart?id=<%=id%>&req_type=W" title="add to cart"> Add To Cart</a>
													</h4>
													<hr />
													<p><%=rs.getString("specification")%></p>
													<div class="actionList">
														<a class="shopBtn" href="AddToCart?id=<%=id%>&req_type=W">Add to Wish List </a>
													</div>
