		...
		<div class="row">
			<div class="span12">
				<div class="well np">
					<div id="myCarousel" class="carousel slide homCar">
						<div class="carousel-inner">
							<div class="item">
								<img style="width: 100%" src="assets/img/a11.jpeg"
				...
				<div class="well well-small">
					<h3 align="center">View Bidding Products</h3>
					<hr />
									...
									<ul class="thumbnails">
										...
										<%
											...
											PreparedStatement ps1 = con
													.prepareStatement("SELECT DISTINCT(p_id) FROM `bidding_request` where request_by='"
															+ email + "' ORDER BY biiding_amount DESC");
											ResultSet rs1 = ps1.executeQuery();
											Bidding bd = new Bidding();

											while (rs1.next()) {
												String p_id = rs1.getString(1);
												System.out.print("P IDS " + p_id);

												PreparedStatement ps = con
														.prepareStatement("SELECT * FROM `product_details` where id='"
																+ p_id + "' AND status='Not_Sell'");
												...
												while (rs.next()) {
													...
													int ls_bidd = bd.getLastProductBidding(p_id, email);
													String status = bd.getLastProductBiddingStatus(p_id, email);
										%>
										<li class="span3">
											<div class="thumbnail">
												<div class="caption cntr">
													...
													<div class="actionList">
														...
														<button type="button" class="btn btn-success">
															<a style="color: white;" href="paymentProcess?id=<%=id%>">Process
																To Pay</a>
														</button>
														...
														<button type="button" class="btn btn-danger">
															<a style="color: white;" href="#">No Response</a>
														</button>
														<%
															}
														%>
