...
<div class="item">
				...
				<div class="well well-small">
					<h3 align="center">Bidder Registrations</h3>
					<hr class="soften" />
					<div class="row-fluid" align="center">
						<div id="newProductCar" class="carousel slide">
							<div class="carousel-inner">
								<div class="item active" align="center">
												<form action="BidderRegistration" method="post">
										<table style="width: 50%;" align="center" >
											...
											<tr>
												<th>Mobile No</th>
												<td><input type="text" placeholder="Your Mobile NO" class="form-control" name="mobile" required></td>
											</tr>
											<tr>
												<th>Password</th>
