		...
		<div class="row">
			<div class="span12">
				...
				<div class="well well-small">
					<h3 align="center">Welcome View Transaction</h3>
					<hr class="soften" />
							...
							<div class="carousel-inner">
								...
								<tbody>
										<tr class="techSpecRow">
											...
											<td class="techSpecTD2">Base Price</td>
											<td class="techSpecTD2">Bidding Price</td>
											<td class="techSpecTD2">Owner ID</td>
										</tr>
									</tbody>
								<%
								Connection con=ConnectionProvider.getConnection();
								PreparedStatement ps1 = con.prepareStatement("SELECT * FROM `product_details` where status='PaymentDone'");
								...
								while (rs1.next()) 
								{
									...
									int amnt=bd.getBiddingAmount(id);
								%>
										<tr class="techSpecRow">
											<td class="techSpecTD1"><%=i %></td>
											<td class="techSpecTD2"><%=rs1.getString("category") %></td>
											<td class="techSpecTD2"><%=rs1.getString("p_name") %></td>
											<td class="techSpecTD2"><%=rs1.getString("base_price") %></td>
											<td class="techSpecTD2"><%=amnt %></td>	
											<td class="techSpecTD2"><%=rs1.getString("upload_by") %></td>
