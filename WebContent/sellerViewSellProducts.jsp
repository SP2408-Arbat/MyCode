		...
		<div class="row">
			...
			<div class="item">
				...
				<div class="well well-small">
					<h3 align="center">View Sell Products</h3>
					<hr/>
								...
								<div class="item active" align="center">
									<ul class="thumbnails">
										...
										<%
											...
											PreparedStatement ps = con.prepareStatement("SELECT * FROM `product_details` where upload_by='"+email+"' AND status!='Not_Sell'");
											...
											while (rs.next()) 
											{
												...
												int final_price=bd.getProductFinalPrice(id);	
										...
										<li class="span3">
											<div class="thumbnail">
												<div class="caption cntr">
													...
													<hr />
													<p style="color: red;">Final Biding Price&nbsp;<%=final_price %></p>
													<hr/>
													<h4>
													<button type="button" class="btn btn-success"><%=rs.getString("status") %></button>
													</h4>
													<hr />
