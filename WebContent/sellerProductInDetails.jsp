					...
					<div class="well well-small">
						<div class="row-fluid">
							...
							<div class="span7">
								...
								<hr class="soft" />
								<form action="BiddingRequest" method="POST" class="form-horizontal qtyFrm">
									<div class="control-group">
										<input type="hidden" name="p_id" value="<%=id%>">
										<label class="control-label"><span>Base Price:<%=rs.getString("base_price") %>/-</span></label>
										<div class="controls">
											<label class="control-label"><span>Expected: <%=b_price_new %>/-</span></label>
										</div>
									</div>
									<h4>Bidding Time</h4>
									<div class="control-group">
									...
									<div class="control-group">
										<label class="control-label"><span>Max Bidding<br/><%=max_bid_amount %></span></label>
									</div>
...
<%} %>
						...
						<ul id="productDetail" class="nav nav-tabs">
							<li class="active"><a href="#home" data-toggle="tab">Bidding Details</a></li>
						...
						<div id="myTabContent" class="tab-content tabWrapper">
							<div class="tab-pane fade active in" id="home">
								...
								PreparedStatement ps1 = con.prepareStatement("SELECT * FROM `bidding_request` where p_id='"+id+"' ORDER BY r_id DESC");
								...
								while (rs1.next()) 
								{
									...
									String bid=rs1.getString("request_by");
								...
								%>
										<tr class="techSpecRow">
											...
											<td><a href="ReadyToSell?p_id=<%=p_id%>&bid=<%=bid %>&r_id=<%=r_id%>">Ready To sell</a></td>
										</tr>
								<%} %>	
								</table>
