								...
								<div class="item active" align="center">
									<ul class="thumbnails">
										...
										<%
											...
											PreparedStatement ps1 = con.prepareStatement("SELECT DISTINCT(p_id) FROM `bidding_request` where request_by='"+email+"' AND status='PaymentDone' ORDER BY biiding_amount DESC");
											...
											while(rs1.next())
											{
												...
												String r_id=bd.getRequestID(p_id, email);
											...
											while (rs.next()) 
											{
												...
												int bd_fnl=bd.getProductFinalPrice(p_id);
